 ...
 * The following variable declarations allow any file that #includes archsim.h
 * to access these variables. The extern keyword means they are provided by a
 * file other than archsim.c or archsim.h.
 */
