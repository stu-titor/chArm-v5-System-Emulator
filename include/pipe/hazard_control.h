...
extern bool check_load_use_hazard(opcode_t D_opcode, uint8_t D_src1,
                                  uint8_t D_src2, opcode_t X_opcode,
                                  uint8_t X_dst);
extern void handle_hazards(opcode_t D_opcode, uint8_t D_src1, uint8_t D_src2,
